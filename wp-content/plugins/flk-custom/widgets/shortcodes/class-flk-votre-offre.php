<?php
/**
 * Shortcode pour afficher le groupe de champs => Votre Offre
 */
 ...
 */
class FLK_Shortcode_Votre_Offre
{
    ...
    public static function output($atts)
    {
        ...
        if ( isset( $_SESSION['data_flk_offre_parent_enfant'] )) {
            ...
            if ( have_rows('field_62e10cad1039f', $id) ) {
                $row = the_row();
        ...
        FLK_Render_template::renderTemplate('widgets/shortcodes/votre_offre', $data);
    }
}
